...
public class PcMania {
    public static void main(String[] args) {
        ...
        int op; //Declaração do operador
        int cont; //Contador para as compras
        int comprar;
        boolean saida;
        ...
        pc[0].marca = "Positivo";
        pc[0].preco = 1300f;
        pc[0].hb[0].nome = "Pentium Core i3 (1200 Mhz)";
        pc[0].hb[0].capacidade = 1200f;
        pc[0].hb[1].nome = "Memoria RAM";
        pc[0].hb[1].capacidade = 4f;
        pc[0].hb[2].nome = "HD";
        ...
        pc[2].hb[0].capacidade = 3500f;        
        pc[2].hb[1].nome = "Memoria RAM";
        pc[2].hb[1].capacidade = 16f;
        pc[2].hb[2].nome = "HD";
